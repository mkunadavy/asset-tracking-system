...
if($_SERVER['REQUEST_METHOD'] == "GET"){
	...
	if($for == "All"){
		...
		$query = "SELECT notes as device,barcode,serialnumber,given_to as assigned_to,category,manufacturer,donorid,device_name from assetregister order by given_to";
